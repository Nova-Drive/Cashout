...
export default function CashoutSquare({ getRegisterDetails }) {
  ...
  function createTotal() {
    ...
    getRegisterDetails(input, result);
  ...
  function handleReset() {
    ...
    setFloat(0);
    setCalculatedCashout(null);
    getRegisterDetails(null, null, null);
  }
        ...
        {calculatedCashout && (
          <>
            <div className="space-x-2 mb-10 flex">
              ...
              <ResultSquare value={cashoutTotal}>Cashout Total</ResultSquare>
